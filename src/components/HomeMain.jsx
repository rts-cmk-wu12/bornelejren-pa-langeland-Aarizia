export default function HomeMain() {
    ...
    return (
        <main>
            ...
            <p>Foreningen Børnelejren på Langeland samler penge ind fra erhvervslivet, fonde og private til at sende dårligt stillede børn på et velfortjent lejrophold på Søgård. <span className="font-weight-bold">Hjælp os med at hjælpe dem!</span></p>
        </main>
    )
}